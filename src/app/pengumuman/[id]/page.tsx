    ...
    const fetchAnnouncement = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/pengumuman-umum/slug/${id}`,
          {
            method: "GET",
            headers: {
        ...
        <div className="flex flex-col justify-center items-center w-full bg-white h-min-[400px] relative z-10 -mt-32 pb-10">
          {isLoading ? (
            ...
            <div className="w-11/12 lg:w-4/5 mt-10 p-6 bg-white rounded-lg shadow-lg">
              <h1 className="text-darkBlue font-semibold text-3xl mt-4 md:mt-2">
                {announcement.judul}
              </h1>
              ...
              <div
                className="mt-6 summernote-content"
