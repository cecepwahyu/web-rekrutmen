    ...
    const fetchArticle = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/artikel/slug/${slug}`,
          {
            method: "GET",
            headers: {
      ...
      <main className="pt-28 bg-gradient-to-r from-[#015CAC] to-[#018ED2] relative z-10">
        ...
        <div className="flex flex-col justify-center items-center w-full bg-white h-min-[400px] relative z-10 -mt-32">
          {isLoading ? (
            ...
            <div className="w-full lg:w-[90%] xl:w-[85%] mt-6 mb-10 px-4">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4 md:p-8">
                  <h1 className="text-darkBlue font-semibold text-3xl md:text-4xl mt-8 mb-4 md:mt-6 md:mb-6 text-center">
                    {article.judul}
                  </h1>
