        ...
        <div className="min-h-screen bg-gray-100 font-sans relative">
            ...
            <main className="pt-28 bg-gradient-to-r from-[#015CAC] to-[#018ED2] relative z-10">
                ...
                <div className="flex flex-col justify-center items-center w-full bg-white min-h-[400px] relative z-10 -mt-32 px-4 md:px-8 lg:px-16 xl:px-32">
                    <h1 className="text-darkBlue font-semibold text-3xl mt-4 md:mt-2">INFORMASI PERSONAL</h1>
                    <br />
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <div className="bg-white p-6 rounded-lg shadow-lg w-full">
                                <div className="mb-4">
                                    <label className="block text-darkBlue font-bold mb-2" htmlFor="profileInfo">
                                        INFORMASI PROFIL
                                    </label>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="mb-4 md:col-span-1 flex flex-col justify-center items-center">
                                        <div className="w-24 h-24 mb-4 rounded-full bg-gray-200 flex items-center justify-center">
                                            <Image src="/path/to/placeholder-image.jpg" alt="Profile Placeholder" width={96} height={96} className="rounded-full" />
                                        </div>
                                        <button className="bg-gray-200 px-4 py-2 rounded-lg focus:outline-none focus:ring">
                                            Ubah Foto Profil
                                        </button>
                                    </div>
                                    ...
                                    {/* <div className="mb-4 md:col-span-1">
                                        <label className="block text-gray-700 font-bold mb-2" htmlFor="telpAlt">
                            ...
                            <section className="bg-white p-6 rounded-lg shadow-lg w-full mt-10">
                                <div className="mb-4">
                                    <label className="block text-darkBlue font-bold mb-2" htmlFor="mediaSosial">
                                        MEDIA SOSIAL
                                    </label>
                                </div>
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-bold mb-2" htmlFor="usernameInstagram">
                                        Username Instagram
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-bold mb-2" htmlFor="facebookAccount">
                                ...
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-bold mb-2" htmlFor="xUsername">
                                        Username X
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-bold mb-2" htmlFor="linkedinAccount">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring"
                                        placeholder="Ketik link akun Linkedln"
                                    />
                                </div>
                            </section>
